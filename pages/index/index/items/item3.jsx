...
function getColor(value) {
    ...
    const gradient = [
        { stop: 0.0, color: '#f3f4f6' },
        { stop: 0.2, color: '#fef3c7' },
        { stop: 0.4, color: '#fdba74' },
        { stop: 0.6, color: '#f97316' },
        { stop: 0.8, color: '#dc2626' },
        { stop: 1.0, color: '#7f1d1d' },
    ];
        ...
        !loaded ? <Skeleton active /> : <div className=''>
            ...
            <div className={"flex h-full flex-row gap-4"}>
                ...
                <div
                    ...
                    style={{
                        background: 'linear-gradient(to top, #7f1d1d, #dc2626, #f97316, #fdba74, #fef3c7, #f3f4f6)', // đỏ đậm → nhạt
                    }}
                >
