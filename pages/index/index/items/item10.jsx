...
export default () => {
    ...
    return (
        !loaded ? <Skeleton active /> :
            <div className='p-2'>
                <p className='text-xl font-bold'>{`10. Bảng chỉ số về tình trạng sức khỏe và dịch vụ y tế`}</p>
                ...
                <div className="h-[500px] overflow-auto gap-6">
                    ...
                    <p className='flex flex-row items-center gap-2 w-full place-self-end self-end text-end'>*<TiWarning className='text-orange-400' /> <span className='italic'>Cơ sở y tế chưa nhập liệu</span></p>
                    {/* Legend */}
